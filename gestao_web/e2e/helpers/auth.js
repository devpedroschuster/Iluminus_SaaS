...
export async function loginComoAdmin(page, email, senha) {
  // DEBUG TEMP (ILU-60 follow-up): reconfirmando causa raiz após atualização
  // do secret E2E_ADMIN_PASSWORD — remover depois de identificar. Não loga
  // valores de formulário (email/senha).
  const eventos = [];
